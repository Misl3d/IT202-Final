...
<header class="WelcomeHead">Bitcoin Tranfer</header>
...
<div class=dash-main> 
	...
	<div class="dash-transactions">
     ...
     <p>  
     	<input type="radio" name="account" value="saving"> Savings
  	 	<input type="radio" name="account" value="checking"> Checkings<br> 
     </p>
